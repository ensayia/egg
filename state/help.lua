...
help.items = {
	...
	[11] = 	' move node:                        '..'['..option.kb_mod..']'..'+'..'['..option.kb_up..']'..'/'..'['..option.kb_down..']',
	[12] = 	' save all data:                    '..'['..option.kb_mod..']'..'+'..'['..option.kb_save..']',
	[13] = 	' exit egg (saves on exit)          '..'['..option.kb_escape..']['..option.kb_escape..']',
	[14] = 	'',
	[15] =	'edit text:',
	[16] =	' text block navigation:            '..'['..option.kb_up..']'..'/'..'['..option.kb_down..']'..'/'..'['..option.kb_left..']'..'/'..'['..option.kb_right..']',
	[17] =	' new line:                         '..'['..option.kb_return..']',
	[18] =	' beginning/end of current line:    '..'['..option.kb_home..']'..'/'..'['..option.kb_end..']',
	[19] = 	' return to node select:            '..'['..option.kb_escape..']',
	[20] = 	'',
	[21] =  'press [esc] to exit this menu',
